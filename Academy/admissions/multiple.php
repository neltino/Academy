...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Multiple Student ID Card</h1>
				</div>
	...
	<form name = "myform" action = "multipling.php" method = "POST" enctype = "multipart/form-data">
