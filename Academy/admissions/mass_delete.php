...
<body>
		...
		<form action="mass_delete_action.php" method = "POST" enctype = "multipart/form-data"> 
			<table>
					<caption>Please select students to be deleted en masse!</caption>
						<th>S/&#x2116;</th>
					...
					<input type="submit" value = "Delete Student(s)" />
		</form>
</body>
</html>