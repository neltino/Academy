...
<body>
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Delete Subject</h1>
				</div>
		...
		<?php
			...
			echo "<h3>Are you sure you want to delete <i style = 'color:magenta;'>$result[subject]</i> ?</h3>";
		
		?>
		
	<div class = "all">	
		<form action="subject_delete_action.php" method = "POST" enctype = "multipart/form-data"> 
			...
			<div class="no">
					<button class = "w3-input w3-round w3-green w3-hover-blue" onclick = 'window.location.href="subjects.php" '>No</button>
			</div>
	</div>
