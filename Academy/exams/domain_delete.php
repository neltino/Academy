...
<body>
			...
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Delete Psychomotor/Affective Domain Item</h1>
				</div>
		...
		<?php
			...
			$id = $_POST['delete'];
			$query = "SELECT domain FROM domains WHERE ID = '$id'";
			$submit = mysqli_query($Father, $query);
			$result = mysqli_fetch_assoc($submit);
			echo "<h3>Are you sure you want to delete <i style = 'color:red;'>'$result[domain]'</i> ?</h3>";
		
		?>
		
		
		<form action="domain_delete_action.php" method = "POST" enctype = "multipart/form-data"> 
		...
		<div class="no">
			<button class = "w3-input w3-round w3-green w3-hover-blue" onclick = 'window.location.href="domains.php" '>No</button>
