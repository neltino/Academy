...
<head>
	...
	<title>.:3rd Term Broadsheets:.</title>
...
<body>
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >3rd Term Broadsheet</h1>
				</div>
			<?php include 'asideexams.php';?>

			<h3><i>Please select class!</i></h3>
			
			<form name = "myform" action="broad_third.php" method = "POST"	enctype = "multipart/form-data">
