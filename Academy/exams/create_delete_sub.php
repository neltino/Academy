<?php
	include '../all_conn.php';
	 ...
	 $id = $_POST['delete'];
	$query = "SELECT name, username, status FROM users_sub WHERE ID = '$id'";
...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Delete Subject Teachers</h1>
				</div>
			<?php include 'asideexams.php';?>
		
	<h3>Are you sure you want to delete <i><?php echo $result['name'];?> </i> ?</h3>
	<div class="all">
			<form action= 'create_delete_sub_action.php' method = 'POST' enctype = 'multipart/form-data'>
						<br /><br />
				...
				<div class="no">
					<button class = "w3-input w3-round w3-green w3-hover-blue" onclick = "window.location.href = 'users_sub.php' " >No</button>
				</div>
	</div>
</body>
</html>
