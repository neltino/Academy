...
<head>
	...
	<title>.:2nd Term Broadsheets:.</title>
...
<body>
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >2nd Term Broadsheet</h1>
				</div>
			<?php include 'asideexams.php';?>

			<h3><i>Please select class!</i></h3>
			
			<form name = "myform" action="broad_second.php" method = "POST"	enctype = "multipart/form-data">
				...
				<select onchange = "myfunct()" class = "w3-select w3-round w3-border-green" name="class" required >
					...
					<?php
						...
						if(mysqli_fetch_assoc($submit1) == NULL){
							echo "<option value='no_class'>No Class Created Yet</option>";
						}else{
