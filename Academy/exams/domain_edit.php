...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Edit Psychomotor/Affective Domain Item</h1>
				</div>
		...
		<?php
			...
			echo "<h3>Edit '<i style = 'color:red;'>$result[domain]</i>'</h3>";
		
		?>
		
		
			
		<form action="domain_edit_action.php" method = "POST" enctype = "multipart/form-data"> 
			<fieldset> 
					<legend>Edit Domain Item</legend>
					<label for="username">Item:</label>
					<input class = "w3-input w3-round w3-border" type="text" name = "domain" value = '<?php echo $result["domain"]?>'  required />
