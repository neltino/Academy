<?php
		...
		$id = $_POST['id'];
		$asis = $_POST['asis'];
		$myclass = $class."_3rd_term_".$subject;
...
<head>
	...
	<title>.:Edit Records_3rd Term:.</title>
...
<body>
			<div class = "noprint">
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Edit 3rd Term CA & Exams Record</h1> 
					
		</div>
		<?php include 'asidesub.php' ?>
		
			<form action="record_3_edit_action.php" method = "POST" enctype = "multipart/form-data"> 
				<fieldset> 
					<legend>Edit Student Record</legend>
						<h4><i>Please Enter new values to edit student record for <b style = "color: #4caf50"> <?php echo $_POST['asis']; ?> </b>!</i></h4> <br />
