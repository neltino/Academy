<?php
		...
		$id = $_POST['id'];
		$asis = $_POST['asis'];
		$myclass = $class."_2nd_term_".$subject; //change
...
<head>
	...
	<title>.:Edit Records_2nd Term:.</title> 
...
<body>
			<div class = "noprint">
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Edit 2nd Term CA & Exams Record</h1> 
					
		</div>
		<?php include 'asidesub.php' ?>
		
			<form action="record_2_edit_action.php" method = "POST" enctype = "multipart/form-data"> 
				<fieldset> 
