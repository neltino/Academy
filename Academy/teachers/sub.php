...
<head>
	...
	<title>.:Subject Teacher's Login:.</title>
	...
	<style type="text/css"> 
		...
		*{
		...
		body{
				background: url(../img/serenghetti.jpg) repeat;
...
<body>
				<div id = "myhead" class = "w3-container w3-dark-grey" >
					<div class = "home">
						<span class = "fas fa-home fa-4x" onclick = "window.open('../index.php', '_self')"></span>
					</div>
						<h1 class = "w3-center" > SUBJECT TEACHERS' LOGIN </h1>
		...
		<form action="login_sub_action.php" method = "POST" enctype = "multipart/form-data">
		<fieldset>
		...
		<div class="forget"> 
					<span onclick = "window.open('sub/forget_sub.php', '_self')">Forget password?</span>
		</div>
