...
<head>
	...
	<title>.:3rd Term Broadsheet:.</title>
...
<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >3rd Term Broadsheet for <span id = 'theClass' ><?php echo $class;?></span></h1> 
		...
		//fetching school name 
			...
			<h3>3RD TERM BROADSHEET FOR <?php 
			$session = date('F');
...
<div class="mytable">
		...
		<script>
			...
			function myReload(){
					...
					request.open("POST", "calculate3.php", true); //change
