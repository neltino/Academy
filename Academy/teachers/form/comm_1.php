...
<body onload = 'funct()' >
	<?php
		//checking if database is empty!
			...
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Comment for <?php echo $class;?></h1> 
	...
	//checking for changes on totals
		...
		if($not != ''){
			...
			...Please wait... <br /> 
			...Recalculating....</h2>";
			echo "<form name = 'myform'  action = 'calculate1.php' method = 'POST' enctype = 'multipart/form-data'> 
			...
			echo "<table>";
					...
					while($stud = mysqli_fetch_assoc($students_query)){
						...
						echo "<tr>";
								...
								echo "<form action = 'class_com_1.php' method = 'POST' enctype = 'multipart/form-data'>";
								...
								echo "</form>";
									if($comm == ""){
										echo "<td class = 'nocom' >No Comment</td>";
									}else{
										echo "<td class = 'com' >Commented &#x2714;</td>";
									}
