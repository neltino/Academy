...
<head>
	...
	<title>.:1st Term Teacher's Comment</title>
...
<body>
	<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Result Summary for <span><?php echo $name;?></span></h1> 
	...
	?>
		<br />
		<form action="class_comm_1_update.php" method = "POST" enctype = "multipart/form-data">
