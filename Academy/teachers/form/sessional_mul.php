...
<head>
	...
	<style type="text/css">
			...
			button, input[type=submit]{
				background: #ffffff; border: 1px solid #6ac239; border-radius: 3px; color: #ef3939; font-weight: bold; margin-left: 350px; margin-top: 20px;
...
<body>
	...
	<div class = "noprint">
		...
		<button onclick = "window.location.href = 'singmul_sessional.php'">Previous Page</button>
...
<?PHP
	...
	$stu = "SELECT ID, name FROM `$myclass` ";
	$stu_query = mysqli_query($Son, $stu);
	
	while($studenting = mysqli_fetch_assoc($stu_query)){
		$id = $studenting['ID'];
		...
		$real = (int)$actual;
				...
				echo '<div class = "header">';
						...
						$ma = number_format($best,2);
						
				echo "<p><b>Name:</b>&nbsp; $name &emsp; &emsp; <b>Class: &nbsp;</b> $class &emsp;&emsp;<b>Term: &nbsp;</b>3rd Term &emsp; <b> Age:</b>&nbsp; $real years</p>";
				echo "<p><b>&#x2116; in Class:</b> &nbsp; $total &emsp; <b>Class Lowest Performance:</b> &nbsp; $mi &emsp;
					<b>Class Highest Performance:</b> &nbsp; $ma </p>";
				...
				echo '</div>';
					...
					// Selecting Position 
						...
						$ok2 = $name.$id."okeytwo";
						echo "<table class = 'special' id = '$ok2' >";
			...
			echo "</div>";
					...
					//comments & others
					echo "<div class = 'comment' style = 'padding-left: 5px;' id = '$ok3' >";
					...
					//Picking sessional average 
							echo "<table class = 'averages' id = '$ok4' >";
		...
		echo "</div>";
			...
			echo '<div class = "right">';
				$thedate = date('Y');
				echo "<b class = 'right'>&copy; <i>TishbehSoft</i>, $thedate </b>";
			
					if($thePhone != ''){
						echo "<i> &emsp; School Contact: <b>$thePhone</b> </i>";
					}
			echo "</div>";
			...
			if($score_query == false){
					...
					echo "<script>
								a = document.getElementById('$ok1').style.visibility = 'hidden';
								b = document.getElementById('$ok2').style.visibility = 'hidden';
								c = document.getElementById('$ok3').style.visibility = 'hidden';
								d = document.getElementById('$ok4').style.visibility = 'hidden';
								e = document.getElementById('$ok5').style.visibility = 'hidden';
