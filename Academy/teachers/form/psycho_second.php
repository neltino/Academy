...
<head>
	...
	<title>.:2nd Term Pyschomotor:.</title>
...
<body>
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >2nd Term Psychomotor-Affective Remark</h1> 
		...
		<?php 
				...
				$register = strtolower(str_replace(" ","",$class."_psycho_2nd_term")); //change
			...
			$reg_query = mysqli_query($Son, $reg);
				...
				$psycho = "Select domain FROM domains";
				...
				if($res == false){
					...
					header('Location: psycho_second.php'); //change
				}
			...
			<?php
				...
				while($mylist = mysqli_fetch_assoc($list_query)){
					...
					echo "<tr>
							<td>$i.</td>
							<td>
									<form action='psycho_2nd_action.php' method = 'POST' enctype = 'multipart/form-data' >
