...
<head>
	...
	<title>.:2nd Term Student Reportsheet:.</title> <!-- change -->
...
<body>
	...
	<div class = "noprint">
		...
		?>
		<button onclick = "window.location.href='report_2.php' ">Previous Page</button> <!-- change -->
		...
		<div class = "page"> 
				...
				<div class = "header">
					...
					<p><b>Name:</b>&nbsp; <?php echo $name;?> &emsp; &emsp; <b>Class: &nbsp;</b> <?php echo $class; ?> &emsp;&emsp;<b>Term: &nbsp;</b>2nd Term &emsp; 
