...
<head>
	...
	<title>.:1st Term Reportsheet:.</title>
...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Single Reportsheet for <?php echo $class;?> </h1> 
			...
			//checking if db is empty!
				...
				//selecting class fields
					...
					if($parameter != $count){
						...
						echo "</em>";
						header("Refresh:3, url=singmul_1.php");
						die();
			...
			echo "<table>";
					...
					while($stud = mysqli_fetch_assoc($students_query)){
						...
						echo "<tr>";
								...
								echo "<form action = 'class_reportsheet_1.php' method = 'POST' enctype = 'multipart/form-data'>";
