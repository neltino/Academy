...
<head>
	...
	<title>.:3rd Term Student Reportsheet:.</title> <!-- change -->
...
<body>
	...
	<div class = "noprint">
		<h1>3rd Term Student Reportsheet</h1> <!-- change -->
		<?php
		...
		?>
		<button onclick = "window.location.href='report_3.php' ">Previous Page</button> <!-- change -->
		...
		<div class = "page"> 
				...
				<div class = "header">
					...
					<p><b>Name:</b>&nbsp; <?php echo $name;?> &emsp; &emsp; <b>Class: &nbsp;</b> <?php echo $class; ?> &emsp;&emsp;<b>Term: &nbsp;</b>3rd Term &emsp; 
					<b> Age:</b>&nbsp; <?php echo $real;?> years</p> <!-- change --> 
				...
				<?php
					...
					$psycho = strtolower(str_replace(" ", "",$class."_psycho_3rd_term")); //change
