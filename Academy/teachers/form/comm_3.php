...
<body onload = 'funct()' >
	...
	//checking for changes on totals
		...
		if($not != ''){
			...
			...Please wait... <br /> 
			...Recalculating....</h2>";
			echo "<form name = 'myform'  action = 'calculate3.php' method = 'POST' enctype = 'multipart/form-data'> 
			...
			echo "<table>";
					...
					while($stud = mysqli_fetch_assoc($students_query)){
						...
						echo "<tr>";
								...
								echo "<form action = 'class_com_3.php' method = 'POST' enctype = 'multipart/form-data'>";
