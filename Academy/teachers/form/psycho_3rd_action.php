<?php
		...
		$new = strtolower(str_replace(" ", "", $class."_psycho_3rd_term")); //change
		$wen = strtolower(str_replace(" ", "", $class."_3rd_term")); //change
...
<head>
	...
	<title>.:3rd Term Psycho Remark:.</title>
	<style type="text/css"> 
					body{
...
<body>
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >3rd Term Psychomotor-Affective Remark for <?php echo $class; ?></h1> 
				</div>
				...
				<form action="psycho_3rd_action_action.php" method = 'POST' enctype = 'multipart/form-data'>
