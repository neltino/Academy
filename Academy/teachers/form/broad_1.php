...
<head>
	...
	<title>.:1st Term Broadsheet:.</title>
	...
	h2,h3,h4,h5{
		...
		@media only screen and (max-width: 768px){
				.what button, .noprint button{font-size: 4vw; margin-left: 1%; width: 98%;}
				h2{font-size: 4vw;}
				h3{font-size: 3vw;}
			}
...
<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Broadsheet for <span id = 'theClass' ><?php echo $class;?></span></h1> 
		...
		<?php 	
			...
			//checking if class exist
				...
				if($a == ""){
						...
						echo "<h3>...You will be redirected to register class subjects!</h3>"; 
				...
				//checking if an existing class has members in it!
					...
					if($ans == NULL){
						...
						echo "<h3>...You will be redirected to register class members!</h3>"; 
		...
		<div class = 'what'>
			<button onclick = 'myReload()' title = 'Calculate/recalculate totals, averages, positions or grades' id = 'butt' class = 'w3-button w3-blue w3-round w3-hover-green'>Compute Grand Totals, Averages & <?php
		...
		//fetching school name 
			...
			<h3>1ST TERM BROADSHEET FOR <?php 
			$session = date('F');
...
<div class="mytable">
			<table class = 'w3-striped'> 
					...
					<?php
						...
						while($namz = mysqli_fetch_assoc($naming_query)){
							...
							echo "<td style = 'text-align: right; padding-left: 0px;' class = 'thick'><b>$i.</b></td>";
		...
		<script>
			...
			function myReload(){
					...
					request.open("POST", "calculate1.php", true); //change
