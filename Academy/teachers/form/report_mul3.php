...
<head>
	...
	<title>.:3rd Term Multiple Reportsheet:.</title> <!-- change -->
...
<body>
	<div class = "noprint">
		...
		<button onclick = "window.location.href='singmul_3.php' ">Previous Page</button> <!-- change -->
	...
	<br />
		...
		while($studenting = mysqli_fetch_assoc($student_query)){
				...
				echo '<div class = "header">';
					...
					echo "<p><b>Name:</b>&nbsp; $name &emsp; &emsp; <b>Class: &nbsp;</b> $class &emsp;&emsp;<b>Term: &nbsp;</b>3rd Term &emsp; <b> Age:</b>&nbsp; $real years</p>"; //change
