...
<body>
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Psychomotor-Affective Remark for <?php echo $class; ?></h1> 
				</div>
				...
				<form action="psycho_1st_action_action.php" method = 'POST' enctype = 'multipart/form-data'>
