...
<head>
	...
	<title>.:1st Term Multiple Reportsheet:.</title>
...
<body>
	<div class = "noprint">
		...
		<button onclick = "window.location.href='singmul_1.php' ">Previous Page</button>
	...
	<br />
		...
		while($studenting = mysqli_fetch_assoc($student_query)){
				...
				echo '<div class = "header">';
					...
					echo "<p><b>Name:</b>&nbsp; $name &emsp; &emsp; <b>Class: &nbsp;</b> $class &emsp;&emsp;<b>Term: &nbsp;</b>1st Term &emsp; <b> Age:</b>&nbsp; $real years</p>";
