...
<body>
		...
		<?php
			...
			echo "<div class='container'>";
					...
					echo "<form action='class_com_2.php' method = 'POST' enctype = 'multipart/form-data'>";//change
					...
					echo "</form>";
						echo "<br /><br />";
						echo "<button onclick = 'window.location.href=`comm_2.php`' class = 'w3-button w3-blue w3-round w3-hover-green'>Comment Page</button>"; //change
