...
<head>
	...
	.home:hover{
		...
		@media only screen and (max-width: 768px){
			h2{font-size: 4vw; margin-top: 10%;}
			
			h3{font-size: 3.5vw; margin-top: 10%;}
...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >Sessional Single Reportsheet for <?php echo $class;?> </h1> 
	...
	<?php
		...
		//checking if db is empty!
			...
			echo "<h3><i>Please click on a name to print sessional reportsheet!</i></h3>";
			...
			echo "<table>";
					...
					while($stud = mysqli_fetch_assoc($students_query)){
						...
						echo "<tr>";
								...
								echo "<form action = 'sessional_reportsheet.php' method = 'POST' enctype = 'multipart/form-data'>";
