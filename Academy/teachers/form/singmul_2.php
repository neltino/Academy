...
<body>
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >2nd Term Single and Multiple Reportsheet</h1> 
		...
		<h3>Please select Reportsheet Option for print!</h3>
			<nav>
				<button class = 'w3-button w3-round w3-blue w3-hover-green' onclick = 'window.location.href="report_2.php" '>Single Reportsheet</button>
				<button class = 'w3-button w3-round w3-blue w3-hover-green' onclick = 'window.location.href="report_mul2.php" '>Multiple Reportsheet</button>
