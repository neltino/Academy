...
<head>
	...
	<title>.:2nd Term CA & Exams Records:.</title>
...
<?php
	...
	//checking if class exists!
			//setting & changing class
					...
					$new = strtolower(str_replace(" ","",$class."_2nd_term")); //change
...
?>
		<div class = "noprint">
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >2nd Term CA & Exam Record</h1> 
		...
		<?php include 'asidesub.php' ?>
								...
								$allsubjects = explode(",", $allsub['subfull']);
											...
											echo " <form name = 'myform' onchange = 'myfunct()' action='../intermediate_sub.php' method = 'POST' enctype = 'multipart/form-data' class = 'newform'>";
													...
													echo "<input type='text' name = 'type' value = 'All' hidden />";
														...
														echo "</select>";
													echo "<input type='text' value = 'Change Class' name = 'record2' hidden />";// change
			...
			if($myca == "2"){
				...
				echo '<form action = "record_action_2.php" method = "POST" enctype = "multipart/form-data" >';
		...
		<?php
				//checking if subject exists
						$mysubject = strtolower(str_replace(" ", "",$class."_2nd_term_".$subject)); //change
		...
		$fields = "DESCRIBE `$new`";
			...
			if(mysqli_fetch_assoc($mysubject_query1) !== NULL){
					...
					echo "<h4>$acad &emsp; TERM: 2ND TERM</h4>";
							...
							echo "<caption class = 'noprint' ><span class = 'fas fa-print fa-2x' onclick = 'window.print()'><small>print</small></span></caption>";
								...
								while($legend = mysqli_fetch_assoc($mysubject_query2)){
									echo "<tr>";
										...
										echo "<form action='record_2_edit.php' method = 'POST' encytype = 'multipart/form-data'>";
			...
			echo "<div class = 'noprint'>";
				echo "<form action='clear_2.php' method = 'POST' enctype = 'multipart/form-data'>";
