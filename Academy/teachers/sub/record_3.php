...
<head>
	...
	<title>.:3rd Term CA & Exams Records:.</title>
...
?>
		<div class = "noprint">
				...
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >3rd Term CA & Exam Record</h1> 
		...
		<?php include 'asidesub.php' ?>
								...
								$allsubjects = explode(",", $allsub['subfull']);
											...
											echo " <form name = 'myform' onchange = 'myfunct()' action='../intermediate_sub.php' method = 'POST' enctype = 'multipart/form-data' class = 'newform'>";
													...
													echo "<input type='text' name = 'type' value = 'All' hidden />";
														...
														echo "</select>";
													echo "<input type='text' value = 'Change Class' name = 'record3' hidden />";// change
			...
			if($myca == "2"){
				...
				echo '<form action = "record_action_3.php" method = "POST" enctype = "multipart/form-data" >';
			echo '<table>';
				echo "<th>S/&#x2116 </th>
				<th>Full Name</th>
				<th>CA1</th>
		...
		<?php
				//checking if subject exists
						$mysubject = strtolower(str_replace(" ", "",$class."_3rd_term_".$subject)); //change
		...
		$fields = "DESCRIBE `$new`";
			...
			if(mysqli_fetch_assoc($mysubject_query1) !== NULL){
				...
				echo "<h2>$school</h2>";
					...
					echo "<h4>$acad &emsp; TERM: 3RD TERM</h4>";
							...
							echo "<caption class = 'noprint' ><span class = 'fas fa-print fa-2x' onclick = 'window.print()'><small>print</small></span></caption>";
								...
								while($legend = mysqli_fetch_assoc($mysubject_query2)){
									echo "<tr>";
										...
										echo "<form action='record_3_edit.php' method = 'POST' encytype = 'multipart/form-data'>";
					...
					echo "<table class = 'table' >";
								echo "<h6>Subject Best Students (Positions 1st, 2nd & 3rd) </h6>";
			...
			echo "<div class = 'noprint'>";
				echo "<form action='clear_3.php' method = 'POST' enctype = 'multipart/form-data'>";
