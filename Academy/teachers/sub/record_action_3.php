...
<?php
		...
		$ter = strtolower($class)."_3rd_term_".$subject; //change
		...
		if($g != ""){
			echo "<h2>Sorry, this class has scores in it already. You can only edit!</h2>";
				header("Refresh: 3, url=record_3.php"); //change
		...
		$new = strtolower($class."_3rd_term"); //change
			...
			$register = strtolower($class)."_3rd_term_".$subject; //change
			...
			if($myca == "2"){
					...
					header('Location: record_3.php'); //change
