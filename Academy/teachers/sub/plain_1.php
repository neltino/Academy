...
<head>
	...
	<title>.:1st Term Plain CA & Exams:.</title>
...
<body>
			<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >1st Term Plain CA & Exam Sheet</h1>
		</div>
		<?php include 'asidesub.php'; ?>
			<h3>Please select Class!</h3>
			<form name = 'myform' onchange = 'myfunct()' action="plain_1_action.php" method = "POST"	enctype = "multipart/form-data">
