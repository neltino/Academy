...
<?php
		...
		$ter = strtolower($class)."_2nd_term_".$subject; //change
		...
		if($g != ""){
			echo "<h2>Sorry, this class has scores in it already. You can only edit!</h2>";
				header("Refresh: 3, url=record_2.php"); //change
		...
		$new = strtolower($class."_2nd_term"); //change
			...
			$register = strtolower($class)."_2nd_term_".$subject; //change
