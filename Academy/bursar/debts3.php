...
<body>
		<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >3rd Term Debts</h1>
				</div>
	...
	<?php
			...
			echo "<br /> <br /> <h3><i>3rd Term Debts</i></h3>";
			while($pay = mysqli_fetch_assoc($item_query)){
				$payment = $pay['payment'];
				$amount = $pay['amount'];
				//selecting payment debtors 
				$debt = "SELECT Class, Surname, FirstName, OtherNames, `$payment` FROM `account3` WHERE `$payment` < $amount ORDER BY Class ASC "; //change
