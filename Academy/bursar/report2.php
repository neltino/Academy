...
<body>
				<div id = "myhead" class = "w3-container w3-blue">
					...
					<h1 class = "w3-center" >2nd Term Payment Report</h1>
				</div>
	...
	<?php
		...
		include '../all_conn.php';
			...
			$tale = 0;
			echo "<br /> <br /><h3><i>2nd Term Payment Report</i></h3>";
			while($pay = mysqli_fetch_assoc($item_query)){
				$payment = $pay['payment'];
				$amount = $pay['amount'];
				//selecting payment debtors 
				$debt = "SELECT Class, Surname, FirstName, OtherNames, `$payment` FROM `account2` ORDER BY Class ASC "; //change
				...
				echo "<table>";
							...
							//fetching Info
								...
								//calculating totals
								$totaling = "SELECT SUM(`$payment`) AS `total` FROM `account2`"; //change
