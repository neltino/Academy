...
include 'bursar_conn.php';
		...
		$sql = "SELECT * FROM account2 ORDER BY Class";
...
<head>
	<meta charset="UTF-8">
	<title>All Students Transaction (2nd Term)</title>
...
<body>
	...
	<caption><h2>Easysoft International College</h2></caption>
		<caption> <strong>All Students Transaction Details[2nd Term] </strong></caption> 
	...
	<?php
			...
			$sum = "SELECT SUM(SchoolFee), SUM(PTA), SUM(Practicals), SUM(Others) FROM account2";
	...
	<button><a href="term2.php" style = "text-decoration: none; font-weight: bold; color: #ff0000;">Back to Search Page</a></button>
	</body>
